...
class Absolvent extends React.Component {
    ...
    return(
      <div className="app">
        ...
        <div className="app__content">
          ...
          <SimpleSeltin label="Studiengang" options={this.options1}/>
          ...
          <nav>
            <ButtonLink cStyle={{marginTop:'20px', width:'200px', textTransform:'none'}} title="Weiter" link="/passwort5"/>  
